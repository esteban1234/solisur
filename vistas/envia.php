...
//To address and name
$mail->addAddress("info@corporativosolisur.com");



$mail->isHTML(true);

$mail->Subject = "Cotización COORPORATIVO SOLISUR";
$mail->Body = "
              <!DOCTYPE html>
                <html>
                <head>
                ...
                <h1 style='text-align:center;  font-weight: bold'> COORPORATIVO SOLISUR</h1>
